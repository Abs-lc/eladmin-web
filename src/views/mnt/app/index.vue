<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" highlight-current-row style="width: 100%" @selection-change="crud.selectionChangeHandler" @current-change="handleCurrentChange">
      ...
      <el-table-column prop="port" label="服务ID" />
      <el-table-column prop="uploadPath" label="所属系统" />
      <el-table-column prop="deployPath" label="报文格式" />
      <el-table-column prop="backupPath" label="服务调用地址" />
      <el-table-column prop="createTime" label="服务版本" />
